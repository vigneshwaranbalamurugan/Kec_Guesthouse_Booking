...
itRouter.post('/handle-date', async (req, res) => {
  ...
  weekafter.setDate(today.getDate() + 5);
...
itRouter.post('/bookslot', async (req, res) => {
...
itRouter.get('/table', async (req, res) => {
  const bookings = await Booking.find();
  res.json(bookings);
})
itRouter.get('/pending', async (req, res) => {
...
itRouter.post('/aprove', async (req, res) => {
  try {
...
itRouter.post('/deny', async (req, res) => {
  try {
